...
function languagesScore(mentee, mentorArray, languagesWeighting){
    for (let i=0; i<mentorArray.length(); i++ ){
        for (let j=0; j<mentee.languagesSpoken.length(); j++ ){
            if (mentorArray[i].languagesSpoken.contains(mentee.languagesSpoken[j])){
...
function availabilityScore(mentee, mentorArray, availabilityWeighting){
    for (let i=0; i<mentorArray.length(); i++ ){
        for (let j=0; j<mentee.availability.length(); j++ ){
            if (mentorArray[i].availability.contains(mentee.availability[j])){
...
function getTotalScores(mentee, mentorArray, locationWeighting, teachingWeighting, languagesWeighting, genderWeighting, availabilityWeighting){
